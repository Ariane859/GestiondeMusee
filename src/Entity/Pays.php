...
class Pays
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Musee::class, mappedBy="codePays", orphanRemoval=true)
     */
    private $musees;

    /**
     * @ORM\OneToMany(targetEntity=Ouvrage::class, mappedBy="codePays", orphanRemoval=true)
     */
    private $ouvrages;

    /**
     * @ORM\OneToMany(targetEntity=Site::class, mappedBy="codePays", orphanRemoval=true)
     */
    private $sites;
